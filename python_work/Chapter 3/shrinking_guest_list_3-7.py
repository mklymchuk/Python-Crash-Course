...
print("Dear guests, new table wont arrive in time, and I can invate only two people")

for i in range(0,len(guests)-2):
    print(f"I very sorry, but i must to canel your invitation mr {guests.pop(0)}")

for i in range(0,len(guests)):
    print(f"Dear mr {guests[i]}, I would like to invate you to dinner at 19:00")

guests.remove("Sokrates")
guests.remove("John Xina")
