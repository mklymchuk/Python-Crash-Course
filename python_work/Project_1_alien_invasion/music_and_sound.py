...
class MusicAndSound:
    ...
    def play_background_music(self):
        ...
        self.main_theme = pygame.mixer.music.load(
            'python_work/Project_1_alien_invasion/sounds/main_theme.wav'
            )
    ...
    def press_button_sound(self):
        ...
        self.button_sound = pygame.mixer.Sound(
            'python_work/Project_1_alien_invasion/sounds/press_button_sound.wav'
        )
    ...
    def play_collision_sound(self):
        ...
        self.collision_sound = pygame.mixer.Sound(
            'python_work/Project_1_alien_invasion/sounds/collision_alien_ship_or_bottom.wav'
        )
    ...
    def bullet_hit_aliens(self):
        ...
        self.bullet_hit_sound = pygame.mixer.Sound(
            'python_work/Project_1_alien_invasion/sounds/bullet_hit_aliens.wav'
        )
    ...
    def play_quit_sound(self):
        ...
        self.exit_sound = pygame.mixer.Sound(
            'python_work/Project_1_alien_invasion/sounds/exit_sound.wav'
        )
